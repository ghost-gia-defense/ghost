...
parser.add_argument("--num_of_samples", type=int, default=10000, help="The number of samples to use")
parser.add_argument("--model_name", type=str, default="roberta-base", help="The model to use")
